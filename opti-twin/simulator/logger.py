"""
Structured logger for the Opti-Twin simulator.
...
class _ColourConsole(logging.Formatter):
    def format(self, record: logging.LogRecord) -> str:
        ...
        return f"{ts} {level} \033[33m[{SERVICE_NAME}]{_RESET} {loc}  {msg}"
...
def get() -> logging.Logger:
    ...
    return _logger if _logger is not None else logging.getLogger("sim")
