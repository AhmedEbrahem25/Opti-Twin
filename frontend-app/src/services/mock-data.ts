...
const MACHINE_NAMES: Record<string, string[]> = {
  motor: ["Primary Motor", "Drive Motor A", "Conveyor Motor", "Mixer Motor"],
  furnace: ["Arc Furnace #1", "Batch Furnace #2", "Heat Treatment Unit"],
  cooling_system: ["Cooling Tower A", "Chiller Unit B", "Cooling Loop C"],
};

export function generateMockFactories(): Factory[] {
  return [
    {
      id: "factory-1", organizationId: "org-1", name: "Cairo Industrial Complex",
      location: "Cairo, Egypt", status: "RUNNING", productionLines: [],
      machineCount: 5, activeAlerts: 2, energyUsageKwh: 847.3,
      costSavedToday: 2340, efficiencyScore: 87,
    },
    {
